...
### 2. The default word-level stress (primary) goes to the **rightmost** foot of a word (<strong><span style="font-variant: small-caps;">MainRight >> MainLeft</span></strong>), and there is only one primary stress (<strong><span style="font-variant: small-caps;">Culminativity</span></strong>).
...
<div style="
  ...
  right: -20px;
">
  <img src="images/me.jpg" width="515px">
</div>
---
class: center, middle
